    ...
    methods: {
        getErrors(name, model) {
            ...
            switch (name) {
                ...
                case 'plan.limit_total':
                case 'plan.premium':
                case 'limit_total':
                    !model.required && errors.push("This field is required.");
                    !model.maxValue && errors.push(`Covered limit cannot be more than ${model.$params.maxValue.max}.`);
                    !model.minValue && errors.push(`Covered limit cannot be less than ${model.$params.minValue.min}`);
                    !model.decimal && errors.push(`Covered limit can only contain decimals`)
                    break;
